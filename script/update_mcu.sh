...
echo ""
make clean
#make menuconfig KCONFIG_CONFIG=/home/howlingpan/klipper_config/script/config.linux_mcu
make KCONFIG=/home/howlingpan/klipper_config/script/config.linux_mcu
read -p "mcu rpi firmware built, please check above for any errors. Press [Enter] to continue flashing, or [Ctrl+C] to abort"
make flash KCONFIG_CONFIG=/home/howlingpan/klipper_config/script/config.linux_mcu
...
echo ""
make clean
#make menuconfig KCONFIG_CONFIG=/home/howlingpan/klipper_config/script/config.skr_turbo_14_mcuXYE
make KCONFIG_CONFIG=/home/howlingpan/klipper_config/script/config.skr_turbo_14_mcuXYE
...
echo ""
make clean
#make menuconfig KCONFIG_CONFIG=/home/howlingpan/klipper_config/script/config.skr_turbo_14_mcuZ
make KCONFIG_CONFIG=/home/howlingpan/klipper_config/script/config.skr_turbo_14_mcuZ
